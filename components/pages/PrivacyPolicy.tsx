        ...
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Effective date: January 2, 2026</DialogDescription>
                </DialogHeader>
                <div className="space-y-6">
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">3. Data Storage</h2>
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">4. Cookies</h2>
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">5. Analytics</h2>
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">6. Data Sharing</h2>
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">7. User Rights</h2>
                    ...
                    <article>
                        <h2 className="text-lg font-medium mb-2">8. Privacy Policy Changes</h2>
